...
IUSE="bluetooth connection-sharing consolekit +dhclient dhcpcd gnutls gtk-doc +introspection kernel_linux +nss +modemmanager ncurses +ppp resolvconf selinux systemd teamd test usr-doc vala +wext +wifi zeroconf" # wimax
