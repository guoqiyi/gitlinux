...
LICENSE="GPL-2"
SLOT="0"
IUSE="+blksha1 +curl cgi doc emacs gnome-keyring +gpg gtk highlight +iconv mediawiki +nls +pcre +perl python ppcsha1 tk +threads +webdav xinetd cvs subversion test usr-doc"
